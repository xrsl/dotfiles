...
# mise is the bootstrap root and owns developer runtimes and CLI tools. Keep a
# Homebrew-managed mise current before consuming a lockfile generated by newer
